...
max_skins = 8
font_color = cyan
skin1 = pygame.image.load("skins/skin_radio.png")
skin2 = pygame.image.load("skins/skin_weather.png")
skin3 = pygame.image.load("skins/skin_status.png")
...
def live_cam(count):
    while (count >= 0):
       picture = pygame.image.load("/var/ramfs/pic.jpg")
       picture = pygame.transform.scale(picture, (320, 240))
       
       osd_text = "live cam ", round(count*2, 1)
       osd_text = str(osd_text)
       chars_to_remove = ["(", ")", ",", "'"]
       osd_text = osd_text.translate(None, ''.join(chars_to_remove))
       osd = font.render(osd_text, 1, (font_color))
       
       screen.blit(picture, (0, 0))
       screen.blit(osd, (25, 170))
       pygame.display.flip()
    ...
    osd_text = 'show again'
    osd_x = 'X'
    osd = font.render(str(osd_text), 1, (font_color))
    quit = font.render(str(osd_x), 1, (font_color))

    screen.blit(picture, (0, 0))
    screen.blit(osd, (25, 170))
    screen.blit(quit, (275, 32))
...
def on_touch():
    ...
    if 224 <= pos[0] <= 306 and 11 <= pos[1] <= 113:
